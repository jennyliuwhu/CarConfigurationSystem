...
public class FileIO {
	...
	public Automobile buildAutomobileObject(String fileName) throws AutoException {
		return buildAutomobileObject(fileName, fileName.split("\\.")[1]);
	}
	/**
	 ...
	 */
	private Automobile buildAutomobileObject(String fileName, String fileType) throws AutoException {
		switch(fileType) {
		case "txt": return buildAutomobileFromTXT(fileName);
		case "properties": return buildAutomobileFromProp(fileName);
		default: return buildAutomobileFromTXT(fileName);
		}
	}

	private Automobile buildAutomobileFromProp(String fileName) {
